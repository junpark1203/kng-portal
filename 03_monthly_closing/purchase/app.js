...
const app = {
    ...
    loadData: async function() {
        try {
            ...
            // We just update the counts based on current fetched page (for real total it needs a separate API call, but let's just show local)
    ...
    submitSettlement: async function() {
        ...
        try {
            await window.authFetch(`${API_BASE}/settlement/inbound`, {
                method: 'POST',
                body: JSON.stringify({
                    ids: selected,
