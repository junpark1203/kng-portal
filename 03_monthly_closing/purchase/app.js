...
const app = {
        ...
        if (partnerVal) {
            chips.push(`
                <span class="badge rounded-pill bg-light text-dark border d-inline-flex align-items-center gap-1 py-1 px-2">
                    <span class="text-secondary fw-normal"><i class='bx bx-building'></i> 매입처:</span> <strong>${partnerVal}</strong>
    ...
    renderTable: function(data) {
        ...
        if (window.ErpGridResizer) {
            window.ErpGridResizer.init('mainTable', { storageKey: 'kng_purchase_grid_widths' });
        }
    },
